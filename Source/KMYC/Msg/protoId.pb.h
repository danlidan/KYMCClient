...
const ProtoId ProtoId_MIN = RegisterReqId;
const ProtoId ProtoId_MAX = MatchCancelRspId;
...
template <> struct is_proto_enum< ::msg::ProtoId> : ::google::protobuf::internal::true_type {};
template <>
